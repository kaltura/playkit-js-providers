...
import XmlParser from '@playkit-js/core-provider/src/util/xml-parser';
import getLogger from '@playkit-js/core-provider/src/util/logger';
import OVPConfiguration from './config';
import MediaEntry from '@playkit-js/core-provider/src/entities/media-entry';
import Drm from '@playkit-js/core-provider/src/entities/drm';
...
import Playlist from '@playkit-js/core-provider/src/entities/playlist';
