...
var _kalturaPlaybackSource = __webpack_require__(23);
...
var _dataLoaderManager = __webpack_require__(32);

var _dataLoaderManager2 = _interopRequireDefault(_dataLoaderManager);

var _sessionLoader = __webpack_require__(33);
...
var _providerParser = __webpack_require__(34);

var _providerParser2 = _interopRequireDefault(_providerParser);

var _kalturaAsset = __webpack_require__(12);
...
var _assetService = __webpack_require__(35);
...
var _userService = __webpack_require__(36);
...
var LIVE_ASST_OBJECT_TYPE = "KalturaLinearMediaAsset";
  ...
  _createClass(OTTProviderParser, null, [{
    ...
    value: function _getPoster(pictures) {
      if (pictures && pictures.length > 0) {
        ...
        var url = picObj.url;
        var regex = /(width|height)\/\d*\/(height|width)\/\d*/g;
        var end = url.search(regex);
        if (end > -1) {
          return url;
        }
        return pictures;
